# Support for Output Descriptors in Goldcoin Core

Since Goldcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Goldcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Goldcoin Core wallets, a convenience function `combo` is
