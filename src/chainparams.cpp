...
{
    const char* pszTimestamp = "AAS NEWS 3/3/2021 Water officials feared sparking panic before outage";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1614824467, 2089229142, 0x1e0ffff0, 1, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcbd88f08056e0869958c260a68269d2383103fc5612ccf8ba1f40de04dbd32b5"));
        assert(genesis.hashMerkleRoot == uint256S("0x c9ad6fcb31e7f105ae6bbd02613458691d80886d10635990bd7febaa0c9e296e"));
...
//        vSeeds.emplace_back("seed-a.goldcoin.loshan.co.uk");
//        vSeeds.emplace_back("dnsseed.thrasher.io");
//        vSeeds.emplace_back("dnsseed.goldcointools.com");
//        vSeeds.emplace_back("dnsseed.goldcoinpool.org");
        ...
        checkpointData = {
            {
                    {  0, uint256S("0xcbd88f08056e0869958c260a68269d2383103fc5612ccf8ba1f40de04dbd32b5")},
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4963625a4b2851d9fdee139e56211a0d88575f59ed816ff5e6a63deb4e3e29a0"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.goldcointools.com");
        vSeeds.emplace_back("seed-b.goldcoin.loshan.co.uk");
