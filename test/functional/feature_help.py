...
"""Verify that starting goldcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start goldcoin with -h for help text")
        ...
        self.log.info("Start goldcoin with -version for version information")
